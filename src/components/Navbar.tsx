...
const [post,setPost] = useState(false)
  ...
  return (
    <div className="flex pl-20 pt-4 shadow-md h-16 w-screen">
        <img src={Quora} className="w-24 h-8 ml-12 " />
       ...
       <h1 onClick={()=>setPost(true)} className="bg-red-700 rounded-full text-sm  text-white w-36 pl-6 ml-6 pt-2 h-9">Add question</h1>
